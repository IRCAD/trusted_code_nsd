...
class MSDeformAttn(nn.Module):
    ...
    def forward(
        ...
        :param input_spatial_shapes        (n_levels, 3), [(D_0, H_0, W_0), (D_1, H_1, W_1), ...,
                                            (D_{L-1}, H_{L-1}, W_{L-1})]
        :param input_level_start_index     (n_levels, ), [0, D_0*H_0*W_0, D_0*H_0*W_0+D_1*H_1*W_1,
                                            D_0*H_0*W_0+D_1*H_1*W_1+D_2*H_2*W_2, ..., D_0*H_0*W_0+D_1*H_1*W_1+...
                                            +D_{L-1}*H_{L-1}*W_{L-1}]
        :param input_padding_mask          (N, sum_{l=0}^{L-1} D_l cdot H_l cdot W_l),

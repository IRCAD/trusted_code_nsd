...
$EXE -x shape${X}.txt -y shape${Y}.txt -J300 -K100 -p -r1 -c1e-6 -g 10 -n1000 -b2   -l50 -o${pfx1}_ -DB,4000,0.08
$EXE -x shape${X}.txt -y ${fn1}.txt    -J300 -K100 -p -r1 -c1e-6 -g.10 -n1000 -b1.2 -l50 -o${pfx2}_ -DB,4000,0.08 -ux

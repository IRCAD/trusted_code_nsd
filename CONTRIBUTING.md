...
Welcome to `trusted_datapaper_ds` contributor's guide.
...
If you experience bugs or general issues with `trusted_datapaper_ds`, please have a look
...
You can help improve `trusted_datapaper_ds` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`trusted_datapaper_ds` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `trusted_datapaper_ds`'s files. While this mechanism can
...
```
conda create -n trusted_datapaper_ds python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/trusted_datapaper_ds.git
...
5. Install [pre-commit]:
   ...
   `trusted_datapaper_ds` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/trusted_datapaper_ds
[issue tracker]: https://github.com/<USERNAME>/trusted_datapaper_ds/issues
